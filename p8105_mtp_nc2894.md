...
and then renamed one column, and used ‘clean\_names()’. Then, I used
‘mutate’ and ‘recode’ to fix errors in three of Raisin’s weight
entries. I then used ‘separate’ and ‘mutate’ to combine the two weight
data into one weight data per dog. Finally, I produced the first tidy
dataframe by using ‘select’ to leave out unnecessary columns.
